 ...
 */
function greenpark_get_sidebar_position() {
    return get_theme_mod( 'greenpark_sidebar_position', 'right' );
}
 ...
 * @return boolean
 */
function greenpark_is_sidebar_disabled() {
    // Check Customizer setting
    if ( get_theme_mod( 'greenpark_sidebar_disable' ) ) {
        return true;
    }

    // Check Legacy setting
    $legacy_disable = greenpark2_get_option('sidebar_disablesidebar');
    if ( $legacy_disable == true ) {
        return true;
    }
