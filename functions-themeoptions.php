            ...
            <form method="post" name="update_form" target="_self">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <textarea name="google_adsense_bottom" style="width: 95%;" rows="10" /><?php echo greenpark2_get_option('google_adsense_bottom'); ?></textarea>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <textarea name="google_analytics" style="width: 95%;" rows="10" /><?php echo greenpark2_get_option('google_analytics'); ?></textarea>
